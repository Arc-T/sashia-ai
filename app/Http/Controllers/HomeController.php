...
class HomeController extends Controller
{
    ...
    public function index()
    {
        $prompts = [
            ...
            [
                'title' => 'کتابخانه اسرارآمیز',
                'image' => 'https://picsum.photos/id/24/600/400', // Books
                'description' => 'کتابخانه‌ای که برخی کتاب‌های آن می‌توانند واقعیت را تغییر دهند. اما خواندن برخی از آن‌ها خطرناک است.',
                'questions' => [
                    'چه کسی این کتابخانه را ساخته است؟',
                    'چگونه می‌توان کتاب‌های خطرناک را تشخیص داد؟',
                    'اگر شما به این کتابخانه دسترسی داشتید، چه کتابی را می‌خواندید؟'
                ]
            ],
            [
                'title' => 'مهمانی ناشناس',
                'image' => 'https://picsum.photos/id/274/600/400', // Party
                'description' => 'مهمانی که دعوت‌نامه‌اش بدون نام فرستنده به دست شما رسیده است. همه مهمانان ماسک زده‌اند و کسی خود را معرفی نمی‌کند.',
                'questions' => [
                    'هدف این مهمانی چیست؟',
                    'چه کسی شما را دعوت کرده است؟',
                    'اگر در این مهمانی متوجه شوید یکی از مهمانان وجود خارجی ندارد، چه می‌کنید؟'
                ]
            ]
        ];
