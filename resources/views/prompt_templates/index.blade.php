        ...
        <div class="uk-container uk-container-expand" id="gallery-content">
                        ...
                        <div class="uk-position-relative">
                            ...
                            <div class="uk-grid uk-grid-small uk-flex-nowrap uk-overflow-hidden" uk-grid>
                                <div class="uk-width-auto">
                                    <ul class="uk-tab uk-tab-small uk-border-rounded uk-background-default uk-box-shadow-small">
                                        ...
                                        @foreach($categories as $category)
                                            <li>
                                                <a href="{{ request()->fullUrlWithQuery(['category' => strtolower($category->name)]) }}"
                                                   class="uk-text-truncate">{{ $category->slug }}</a>
                                            </li>
                                        @endforeach
                                    </ul>
                                </div>
            ...
            <div id="gallery-grid"
                ...
                @foreach ($images as $index => $image)
                    <div>
                        <div class="uk-card uk-card-default uk-card-hover uk-transition-toggle uk-border-rounded uk-box-shadow-small uk-box-shadow-hover-medium">
